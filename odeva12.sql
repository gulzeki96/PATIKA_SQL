...
--SELECT payment.customer_id,customer.first_name, customer.last_name FROM customer INNER JOIN payment ON customer.id = payment.customer_id WHERE payment.amount = (SELECT MAX(amount) FROM payment);
